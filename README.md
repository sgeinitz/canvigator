...
Available tasks: `get-activity`, `create-pairs`, `award-bonus`, `award-bonus-partner-only`, `award-bonus-retake-only`, `get-all-subs`, `get-quiz-questions`, `create-quiz`, `export-anon-data`, `get-gradebook`, `send-quiz-reminder`
